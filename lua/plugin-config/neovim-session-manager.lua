...
require('session_manager').setup({
    ...
    autosave_ignore_dirs = { '/Users/wujiangu'},                         -- A list of directories where the session will not be autosaved.
    ...
    -- set auto load saved session
})

-- set keymaps for loading and saving sessions
vim.api.nvim_set_keymap('n', '<leader>ss', ':SessionManager save_current_session<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>ls', ':SessionManager load_session<CR>', { noremap = true, silent = true })

-- set not auto load saved sessions 